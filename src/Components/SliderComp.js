          ...
          <div>
            ...
            <div className="flex h-[60vh] md:h-[80vh] lg:h-[60vh] bg-[#F7F4FD] items-center justify-center gap-4">
              <div className=" md:w-2/3 w-full px-8 text-center md:px-16 font-bold text-[#1C1678]  z-10 ">
                ...
                <Link to="/courseregistration"><button className="  text-white w-fit md:px-6 md:py-3 p-2 my-2 md:text-xl text-lg rounded-md bg-gradient-to-r from-cyan-500 to-[#CB77F7] cursor-pointer z-20 hover:scale-110 duration-300">
                  Get Started
                </button></Link>
              </div>
