    ...
    const blogData = [
        {
            id: 1,
            img: blog1,
            heading: "Exploring the Intersection of Blockchain and Sustainable Development Goals",
            para: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic",
        },
        {
            id: 2,
            img: blog2,
            heading: "The Rise of Non-Fungible Tokens (NFTs): Opportunities and Challenges",
            para: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic"
        },
        {
            id: 3,
            img: blog3,
            heading: "Decentralized Finance (DeFi) Revolution: Empowering Financial Inclusion",
            para: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic"
        }
    ]
        ...
        <>
            <div style={{
                ...
                objectFit: 'contain',
                 ...
                 <h2 className='font-bold absolute top-1/3 left-12 mx-auto md:text-4xl text-2xl font-headingFont '> Kairaa Blockchain Academy's Blog</h2>
            </div>
          <div className='my-12'>
            ...
            <div className='m-8 items-center justify-center'>
                {blogData.map((dt) => {
                    return (
                        <div className='border-2 flex md:w-4/6 w-full h-64 m-auto  md:mt-24 mt-12' key={dt.id}>
                            <div className=' w-2/5'><img src={dt.img} className='object-cover h-full w-full' /></div>
                            <div className='md:p-8 p-2 w-3/5'>
                                <h2 className='font-bold font-headingFont md:text-xl text-lg my-2 line-clamp-2'>{dt.heading}</h2>
