  ...
  return (
    <>
      ...
      <div className=" md:h-[80vh] my-12  p-4 font-paraFont md:text-2xl text-lg">
        ...
        <div className="flex md:w-3/5 w-full m-auto h-1/2 text-[#15265D] ">
          ...
          <div className="flex flex-col gap-4 md:p-8 p-4 ">
            <h2 className="font-bold  md:text-4xl text-2xl font-headingFont">OUR <span className="text-[#1C4CE4]">VISION</span></h2>
      ...
      <div className="flex gap-8 md:px-24 px-8 md:py-12 py-8  md:flex-row items-center bg-[#F7F4FD]">
        ...
        <div className="flex flex-col gap-4 md:w-3/3 w-full text-md font-medium items-center md:text-2xl text-lg md:px-8 font-paraFont text-center">
            ...
            {info.map((e) => {
              return (
                <div className='flex gap-2 py-4'>
                  <img src={star} className='w-6 h-6' /> <p><span className='text-blue-500 font-bold pr-2'>{e.heading} :</span>{e.para}</p>
                </div>
              )
            })}
          </div>

          <button className="text-white w-fit px-6 py-3 my-2 text-2xl rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer">Know More</button>
        </div>
      </div>
