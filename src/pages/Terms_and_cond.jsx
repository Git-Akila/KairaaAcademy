...
const privacy=[
    ...
    },
    {
        ...
        paragraph:['* If the Customer leaves the Kairaa blockchain academy before they complete their service period, there shall be no entitlement to a refund of paid service fees. ',
  ...
  return (
    ...
    <div className='bg-blue-200 p-20 '>
        <h2 className='ml-5 md:text-6xl lg:text-4xl text-3xl  sm:text-3xl font-bold text-black p-2 border-l-4 border-l-black'>Privacy Policy</h2>
    </div>
